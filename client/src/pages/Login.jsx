...
// const Login = () => {
//   const { login, signup, verifyOtp, navigate } = useContext(ShopContext);
...
//         <>
//           <p className="text-gray-600">Enter OTP sent to your email</p>
...
//               className="bg-luxe text-white rounded-lg py-2 mt-3 hover:bg-luxe-dark transition duration-300"
//             >
//               Verify OTP
//             </button>
//             <button
...
//               className="text-gray-600 border border-gray-300 rounded-lg py-2 hover:bg-gray-50 transition duration-300"
//             >
//               Back to Sign Up
//             </button>
//           </div>
...
//             <button
//               type="submit"
//               className="bg-luxe text-white rounded-lg py-2 mt-5 hover:bg-luxe-dark transition duration-300"
//             >
...
//               }
//               className="text-luxe cursor-pointer hover:underline"
//             >
